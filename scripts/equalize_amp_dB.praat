# This script takes all the files in the specified directory, modify their intensity in dB, 
# and writes new files to a new folder. It takes three arguments: InputDir is the original folder;
# OutputDir is a new folder in which the modified files are stored; dB is a dB value
