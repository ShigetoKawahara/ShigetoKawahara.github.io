# This script takes all the files in the specified directory, modify their scales, 
# and writes new files to a new folder. It takes three arguments: InputDir is the original folder;
# OutputDir is a new folder in which the modified files are stored; Peak is a peak value
# to which you want your files to be modified to. 
# version 4/7/2009

form Files
	sentence InputDir ./input/
